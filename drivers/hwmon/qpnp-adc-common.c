...
// for FAO EVB {{
static const struct qpnp_vadc_map_pt adcmap_FaoUseMcs_batt[] = {
	{-400, 1800}, // add for -128
	{-350, 1673},
	{-300, 1639},
	{-250, 1598},
	{-200, 1550},
...
// for FAO EVB }}
// for FAO EVB EVT {{
static const struct qpnp_vadc_map_pt adcmap_FaoEvt_batt[] = {
	{-400, 1800}, // add for -128
	{-300, 1636},
	{-280, 1621},
	{-260, 1606},
...
// add for FAO use MCS battery {{
int32_t qpnp_adc_scale_fao_batt_therm(struct qpnp_vadc_chip *chip,
		int32_t adc_code,
		const struct qpnp_adc_properties *adc_properties,
		const struct qpnp_vadc_chan_properties *chan_properties,
		struct qpnp_vadc_result *adc_chan_result)
{
	...
	return qpnp_adc_map_temp_voltage(
			adcmap_FaoUseMcs_batt,
			ARRAY_SIZE(adcmap_FaoUseMcs_batt),
			bat_voltage,
			&adc_chan_result->physical);
}
EXPORT_SYMBOL(qpnp_adc_scale_fao_batt_therm);

// add for FAO use MCS battery }}

// add for FAO EVT battery {{
int32_t qpnp_adc_scale_fao_evt_batt_therm(struct qpnp_vadc_chip *chip,
		int32_t adc_code,
		const struct qpnp_adc_properties *adc_properties,
		const struct qpnp_vadc_chan_properties *chan_properties,
		struct qpnp_vadc_result *adc_chan_result)
{
	...
	return qpnp_adc_map_temp_voltage(
			adcmap_FaoEvt_batt,
			ARRAY_SIZE(adcmap_FaoEvt_batt),
			bat_voltage,
			&adc_chan_result->physical);
}
EXPORT_SYMBOL(qpnp_adc_scale_fao_evt_batt_therm);
...
EXPORT_SYMBOL(qpnp_adc_btm_fao_scaler);
// add for FAO }}
...
EXPORT_SYMBOL(qpnp_adc_btm_fao_evt_scaler);
// add for FAO EVT }}
