...
static struct qpnp_vadc_scale_fn vadc_scale_fn[] = {
	...
	[SCALE_FAO_BATT_THERM] = {qpnp_adc_scale_fao_batt_therm}, // add for FAO use MCS battery 
	[SCALE_FAO_EVT_BATT_THERM] = {qpnp_adc_scale_fao_evt_batt_therm}, // add for FAO EVT	
