...
int fih_android_usb_product_id(void)
{
	return device_desc.idProduct;
}
EXPORT_SYMBOL(fih_android_usb_product_id);

int fih_android_usb_check_selinux_status(void)
{
...
EXPORT_SYMBOL(fih_android_usb_check_selinux_status);
