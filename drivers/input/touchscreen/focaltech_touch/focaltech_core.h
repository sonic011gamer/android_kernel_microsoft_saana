...
extern int fts_ctpm_get_app_bin_file_ver(char *firmware_name);	//HL+_20151118
extern int fts_ctpm_get_app_i_file_ver(void);
extern int fts_ctpm_fw_upgrade_with_app_i_file(struct i2c_client *client);
extern int fts_ctpm_fw_upgrade_with_app_bin_file(struct i2c_client *client, char *firmware_name);
