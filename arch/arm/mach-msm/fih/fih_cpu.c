...
static int fih_cpu_read_show(struct seq_file *m, void *v)
{
	...
	switch (device) {
		case HW_REV_NUM_MSM8909: strcpy(msg, "MSM8909, "); break;
		case HW_REV_NUM_MSM8609: strcpy(msg, "MSM8609, "); break;
		case HW_REV_NUM_MSM8209: strcpy(msg, "MSM8209, "); break;
		case HW_REV_NUM_MSM8208: strcpy(msg, "MSM8208, "); break;
		default: strcpy(msg, "Unknown"); break;
	}

	switch (sample_type) {
		case HW_REV_ES: strcat(msg, "ES1, "); break;
