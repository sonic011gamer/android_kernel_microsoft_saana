...
#define FIH_MEM_MEM_SIZE				FIH_MEM_BASE
...
/* no use 5 */
#define FIH_NO_USE_5_BASE				(FIH_NOTE_BASE + FIH_NOTE_SIZE)
#define FIH_NO_USE_5_SIZE				0x00004000
...
#define FIH_NO_USE_6_SIZE				0x00001000

/* no use 7 */
#define FIH_NO_USE_7_BASE				(FIH_NO_USE_6_BASE + FIH_NO_USE_6_SIZE)
#define FIH_NO_USE_7_SIZE				0x00033000
 ...
 * START       | SIZE        | TARGET
 * --------------------------------------------------------
 * 0x8DC0_0000 | 0x0020_0000 | modem rf_nv (2MB)
 * 0x8DE0_0000 | 0x0020_0000 | modem cust_nv (2MB)
 * 0x8E00_0000 | 0x0010_0000 | modem log (1MB)
  * -------------------------------------------------------- 5MB
 * 0x8E10_0000 | 0x0004_0000 | last_alog_main (256KB)
 * 0x8E14_0000 | 0x0004_0000 | last_alog_events (256KB)
 * 0x8E18_0000 | 0x0004_0000 | last_alog_radio (256KB)
 * 0x8E1C_0000 | 0x0004_0000 | last_alog_system (256KB)
 * 0x8E20_0000 | 0x0004_0000 | last_kmsg (256KB)
 * 0x8E24_0000 | 0x0002_0000 | last_blog (128KB)
 * 0x8E26_0000 | 0x0002_0000 | blog (128KB)
 * -------------------------------------------------------- 6.5MB
 * 0x8E28_0000 | 0x0000_0040 | hwid:hwcfg (64B)
 * 0x8E28_0040 | 0x0000_0040 | secboot:devinfo (64B)
 * 0x8E28_0080 | 0x0000_0100 | secboot:unlock (256B)
 * 0x8E28_0180 | 0x0000_0080 | sutinfo (128B)
 * 0x8E28_0200 | 0x0000_0010 | no use (16B)
 * 0x8E28_0210 | 0x0000_0010 | bset (16B)
 * 0x8E28_0220 | 0x0000_0010 | bat-id adc (16B)
 * 0x8E28_0230 | 0x0000_0010 | no use (16B)
 * 0x8E28_0240 | 0x0000_0020 | apr (32B)
 * 0x8E28_0260 | 0x0000_0180 | no use (384B)
 * 0x8E28_03E0 | 0x0000_0020 | mem (32B)
 * 0x8E28_0400 | 0x0000_0C00 | no use (3KB)
 * 0x8E28_1000 | 0x0000_1000 | e2p (4KB)
 * 0x8E28_2000 | 0x0000_1000 | cda (4KB)
 * 0x8E28_3000 | 0x0000_1000 | note (4KB)
 * 0x8E28_4000 | 0x0000_1000 | fac (4KB)
 * 0x8E28_5000 | 0x0000_3000 | no use 5 (12KB)
 * 0x8E28_8000 | 0x0004_0000 | fver (256KB)
 * 0x8E2C_8000 | 0x0000_4000 | sensordata (16KB)
 * 0x8E2C_C000 | 0x0000_1000 | no use 6 (4KB)
 * 0x8E2C_D000 | 0x0003_3000 | no use 7 (204KB)
 * -------------------------------------------------------- 7MB
 * 0x8E30_0000 | 0x0070_0000 | HLOS (7MB)
 */
