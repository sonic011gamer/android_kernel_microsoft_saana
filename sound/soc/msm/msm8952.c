...
static int enable_spk_ext_pa(struct snd_soc_codec *codec, int enable)
{
...
#if 0 /*Rayyou-E1MBringUp-00+{ */
	int ret;
#endif /*Rayyou-E1MBringUpp-00+} */
	...
	//20180112@ray: for debug
	pr_err("%s: [RAY] %s external speaker PA\n", __func__,
		enable ? "Enable" : "Disable");
...
/*Rayyou-E1MBringUp-00+{ */
int is_hp_switch_gpio_support(struct platform_device *pdev,
			struct msm8916_asoc_mach_data *pdata)
{
...
#if 1 //fihtdc@ray: MBHC fine tune for E1M
	btn_low[0] = 90;
	btn_low[1] = 120; 
	btn_low[2] = 220; 
	btn_low[3] = 500; 
...
#if 0 //MBHC default configuration
	btn_low[0] = 75;
	btn_high[0] = 75;
	btn_low[1] = 150;
	btn_high[1] = 150;
...
/*Rayyou-E1MBringUp-00+{ */
	ret = is_hp_switch_gpio_support(pdev, pdata);
	if (ret < 0)
		pr_err("%s:  doesn't support external speaker pa\n",
				__func__);
/*Rayyou-E1MBringUpp-00+} */
